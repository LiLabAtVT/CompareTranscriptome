...
For example, the following line is from GMAX fasta files blast to ATH gene

GLYMA|Glyma.10G183400.1.p ARATH|AT3G18460.1 48.438  128 64  1 11  136 54  181 1.32e-37  129


Algorithm details:
Step 1. sort the data into two list, one for GMAX blast to ATH, one for ATH
blast to GMAX.

Step 2. for each GMAX (ATH) genes, find the one with lowest E value. create a
...
python RBH_061617.py [inputfn] [species1id] [species2id] [outputfn]
